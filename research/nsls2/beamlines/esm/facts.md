...
| Mirror1 | Mirror | `XF:21IDA-OP{Mir:1-Ax:` | mirror 1 (+ integrated Slt:4) | shared / 21-ID-A | source | yes |
| GratingMonochromator | GratingMonochromator | `XF:21IDB-OP{Mono:1` | grating mono (+ slit-defined exit Slt:7/8) | shared / 21-ID-B | source | yes |
| Mirror3 | Mirror | `XF:21IDB-OP{Mir:3-Ax:` | mirror 3 | shared / 21-ID-B | source | yes |
| Mirror4A | Mirror | `XF:21IDC-OP{Mir:4A-` | branch-splitting mirror A (ARPES) | shared / 21-ID-C | source | yes |
| Mirror4B | Mirror | `XF:21IDC-OP{Mir:4B-Ax:` | branch-splitting mirror B (XPEEM) | shared / 21-ID-C | source | yes |
...
| BeamPositionMonitor | GenericProbe (?) | `XF:21IDA-BI{EM:BPM01}` | beam position monitor | shared | source | yes |
| DiagnosticStage | LinearStage | `XF:21IDA-OP{Diag:1` | diagnostic stage | shared / 21-ID-A | source | yes |
