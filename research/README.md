...
| Australian Synchrotron | yes (retrospective) | 1 (IMBL, via C++ controls) + recurrence.md; MX3 deployed | yes | heterogeneous (EPICS + Exporter + REST + TCP); IMBL EPICS topology public via `imbl` C++ repo |
