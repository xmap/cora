...
|---|---|---|---|
| F1 | data | The scrubber: a run-lifecycle / who-drove-it lane (operator vs RunSupervisor), the held band, verdict-colored convergence brackets, activity swim-lanes, and the fold-to-version cursor at the beam-loss instant. Centerpiece. | `render_f1.py` over `lights_out_run.json` |
