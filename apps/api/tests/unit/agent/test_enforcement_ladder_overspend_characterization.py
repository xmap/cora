...
deterministic. Only the two production tiers are measured; the alert-only
tier is not a control and the leak-free reserve-post-void tier is not yet
built (both are analytical rows in the paper's table).
