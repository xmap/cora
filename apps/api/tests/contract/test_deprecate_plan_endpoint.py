...
def test_post_deprecate_plan_returns_204_from_defined_state() -> None:
    ...
    with TestClient(create_app()) as client:
        ...
        response = client.post(f"/plans/{plan_id}/deprecate", json={"reason": "Superseded"})
...
def test_post_deprecate_plan_returns_404_when_plan_does_not_exist() -> None:
    ...
    with TestClient(create_app()) as client:
        response = client.post(f"/plans/{missing_id}/deprecate", json={"reason": "Superseded"})
...
def test_post_deprecate_plan_returns_409_when_already_deprecated() -> None:
    ...
    with TestClient(create_app()) as client:
        ...
        second = client.post(f"/plans/{plan_id}/deprecate", json={"reason": "Superseded"})
