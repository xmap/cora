"""Contract tests for the `add_asset_alternate_identifier` MCP tool."""
...
def test_mcp_lists_add_asset_alternate_identifier_tool() -> None:
    ...
    assert "add_asset_alternate_identifier" in tool_names


@pytest.mark.contract
def test_mcp_add_asset_alternate_identifier_succeeds_on_happy_path() -> None:
    with TestClient(create_app()) as client:
        headers = open_session(client)
...
@pytest.mark.contract
def test_mcp_add_asset_alternate_identifier_returns_iserror_for_unknown_asset() -> None:
    with TestClient(create_app()) as client:
        headers = open_session(client)
        response = client.post(
            "/mcp",
