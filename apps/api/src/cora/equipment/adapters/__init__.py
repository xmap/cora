...
`StubPersistentIdentifierMinter` is the test-tier `PersistentIdentifierMinter` adapter per
...
production `DataCitePersistentIdentifierMinter` adapter is deferred to slice F.2.
