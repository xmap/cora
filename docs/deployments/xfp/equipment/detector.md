...
| `BeamPositionMonitor` | `PositionMonitor` | `XF:17BM-BI{EM:BPM1}` | the Sydor four-channel monitor: per-quadrant currents, beam x / y, and a sum-current total flux (`DIAG-1`) |
