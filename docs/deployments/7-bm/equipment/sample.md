...
The flammable-gas, fuel-vapor, and oxygen-deficiency hazards this environment adds are governance, handled at the [APS Site](../../aps/index.md#safety-and-governance) by clearances and operator Cautions; whether they need a workflow beyond the standard ESAF is HAZ-1 on [Governance](../governance.md).
