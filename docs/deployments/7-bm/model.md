...
| Catalog Family | [`catalog/catalog.yaml`](https://github.com/xmap/cora/blob/main/catalog/catalog.yaml) | no new Family added; 7-BM reuses existing Families and carries four loose design-intent families (`Chopper`, `FlowController`, `Photodiode`, `EnergyDispersiveSpectrometer`) that render as plain text until earned |
