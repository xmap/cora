...
| `BeamPositionMonitor` | PositionMonitor | `MX3DAQIOC04:` | beam-position monitor + PID steering |
...
| Flux / beam-position channel maps | `FluxMonitor` / `PositionMonitor` | `unknown-pending-confirmation` | (DIAG-1) |
| Beam-steering controller device boundary | `PositionMonitor` | `unknown-pending-confirmation` | (STEER-1) |
