...
The Enclosure permit shape for the coherence-branch hutch and the hazard tier are carried pending at the Diamond Site; the governance and safety envelope follow the 2-BM shape (see [Governance](../governance.md) and [the safety envelope](../../diamond/index.md#safety-and-governance)). The Diamond operator pool and review are pending at the Site (GOV-1), and Clearances are issued at the Diamond Site.
