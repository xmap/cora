...
| Extraction provenance | [`research/esrf/beamlines/id16b/`](https://github.com/xmap/cora/tree/main/research/esrf/beamlines/id16b) | the device facts read from [`gitlab.esrf.fr/id16b/beamline_configuration`](https://gitlab.esrf.fr/id16b/beamline_configuration) |
