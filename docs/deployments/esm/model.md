...
| Catalog Family | [`catalog/catalog.yaml`](https://github.com/xmap/cora/blob/main/catalog/catalog.yaml) | `Manipulator` graduates with this deployment (below); `ElectronAnalyzer` graduated once SST earned the 2nd SES |
