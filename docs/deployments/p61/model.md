...
| Kind | Where | Notes |
| --- | --- | --- |
| Beamline descriptor | [`deployments/p61/beamline.yaml`](https://github.com/xmap/cora/blob/main/deployments/p61/beamline.yaml) | the device walk; source of the generated [Source](source.md) page; Tango handles read from the OnlineXML (`CTRL-1`) |
...
| Equipment Assets | not yet registered | the [Inventory](index.md) is the planned shape; no scenario registers P61 Assets yet |
