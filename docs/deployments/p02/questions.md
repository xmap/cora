...
| ID | Priority | Question | CORA assumes | Resolves |
| --- | --- | --- | --- | --- |
| PRESSURE-1 | Blocks-go-live | The P02.2 diamond-anvil-cell control: the membrane / gas-loading / pressure-ramp interface, and the cell's positioning stages. | A `PressureCell` Asset (the allowlisted-loose 13-id-d Family); membrane / load control pending. | The pressure-cell modelling. |
