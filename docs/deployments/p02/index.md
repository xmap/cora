...
- **The diamond-anvil cell reuses the 13-id-d PressureCell.** P02.2 is the second consumer of the allowlisted-loose `PressureCell` Family, crossing the rule-of-three promotion threshold; recorded as a hold (graduation-due) in the loose-family review (`PRESSURE-1`).
