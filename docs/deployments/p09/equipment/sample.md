...
- `PolarizationAnalyzer` binds the catalog `PolarizationAnalyzer` Family (graduated across 4-ID / i10 / ID32 / P09, presenting Positioner): the scattered-beam analyzer; resolves scattered polarization (`POL-2`).
...
- `PolarizationAnalyzer` binds the catalog `PolarizationAnalyzer` Family (graduated across 4-ID / i10 / ID32 / P09, presenting Positioner): the MAG scattered-beam analyzer (`POL-2`).
