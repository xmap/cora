...
| Enclosure (Enclosure) | [The beamline](equipment/index.md) (TPS-07A-OH optics, TPS-07A-EH experiment) |
...
- **No new Capability or Method.** Rotation MX reuses the pending i03 Methods (`mx_data_collection` / `grid_scan` / `sample_exchange`), recorded as Practices on the Site; TPS 07A reinforces the case at a third MX facility without coining any (TECH-1).
