...
| DIAG-1 | Nice-to-have | The beam-position / XBPM and OAV-camera channel maps and PVs. | Read-only beam-position (loose `BeamPositionMonitor`) and OAV (`Camera`) probes; channel maps blank. | The diagnostic bindings. |
