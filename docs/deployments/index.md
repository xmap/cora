...
| [SST](sst/index.md) | Reverse-engineered | soft + tender spectroscopy (RSoXS + HAXPES), 7-ID; graduates the ElectronAnalyzer Family, modelled from public beamline config |
