...
| [4-ID](4-id/index.md) | Model | Controls config | Full | polarization and magnetic scattering across four stations; introduces the POLAR polarization / magnetism vocabulary (loose PhaseRetarder / PolarizationAnalyzer / Magnet, held for gate-review) |
