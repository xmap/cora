...
| [19-BM](19-bm/index.md) | Design | Design report | Full | bending-magnet autonomous high-throughput tomography |
| [32-ID](32-id/index.md) | Design | Narrative | Partial | canted multi-instrument: optics spine and transmission X-ray microscope |
| [12-ID-E](12-id-e/index.md) | Model | Controls config | Full | Bonse-Hart ultra-small-angle X-ray scattering (USAXS), Sector 12; CORA's first USAXS deployment |
| [13-ID-D](13-id-d/index.md) | Model | Controls config | Full | GSECARS high-pressure X-ray diffraction, Sector 13; the fleet's first extreme-conditions (diamond-anvil-cell) sample environment |
| [4-ID](4-id/index.md) | Model | Controls config | Full | polarization and magnetic scattering across four stations; graduates the POLAR polarization / magnetism vocabulary (loose PhaseRetarder / PolarizationAnalyzer / Magnet) |
...
| [P03](p03/index.md) | Model | Controls config | Full | micro- and nanofocus small- and wide-angle X-ray scattering (SAXS / WAXS, 9-23 keV) across shared P02 / P03 optics and two endstations (a microfocus endstation and the nanofocus GINIX waveguide endstation); the fleet's first SAXS / WAXS beamline, coins no new Family, brings Galil DMC and SmarPod controllers, reusing the pending `small_angle_scattering` / `wide_angle_scattering` Methods |
...
| [P09](p09/index.md) | Model | Controls config | Full | resonant scattering, diffraction, and high-field magnetism (XMCD, magnetic scattering) across a resonant-scattering hutch, a diffraction hutch, and a 14 T magnetism endstation; the second consumer of the 4-ID POLAR polarization / magnetism vocabulary (the allowlisted-loose `PhaseRetarder` / `PolarizationAnalyzer` / `Magnet` Families), coins no new Family, reusing the pending `resonant_scattering` / `magnetic_scattering` / `xmcd` Methods |
