...
| Extraction provenance | [`research/aps/beamlines/8id-bits/`](https://github.com/xmap/cora/tree/main/research/aps) | the facts report and candidate the descriptor was curated from |
