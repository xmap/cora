...
[**APS**](../aps/index.md), the Advanced Photon Source, operated by Argonne National Laboratory, is the synchrotron site the operational 2-BM beamline runs at, and where the planned 19-BM-FACT beamline (Sector 19) is in design. Its page is the home for the facts those beamlines inherit but do not own: the Practices (ISA-88 Site Recipes) they run, the Clearances they must hold, the facility Supplies they draw on, and the people and agents registered facility-wide. It is also CORA's first Site to host more than one beamline.
