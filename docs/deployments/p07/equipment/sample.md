...
- `Magnet` binds the allowlisted-loose `Magnet` Family: the EH2 17 T superconducting sample-environment magnet (`magnet17tf`), a further consumer of the 4-ID POLAR Family (`MAG-1`).
