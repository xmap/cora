...
- `Magnet` binds the graduated catalog `Magnet` Family: the EH2 17 T superconducting sample-environment magnet (`magnet17tf`), a further consumer of the Family earned across 4-ID + i10-1 + ID32 (`MAG-1`).
