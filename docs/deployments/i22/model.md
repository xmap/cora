...
| Kind | Where | Notes |
| --- | --- | --- |
| Beamline descriptor | [`deployments/i22/beamline.yaml`](https://github.com/xmap/cora/blob/main/deployments/i22/beamline.yaml) | the device walk, with the dodal-derived EPICS PV handles; source of the generated [Source](source.md) page |
...
| Equipment Assets | not yet registered | the [Inventory](index.md) is the planned shape; no scenario registers I22 Assets yet |
