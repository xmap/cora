...
| Extraction provenance | [`research/aps/beamlines/polar-bits/`](https://github.com/xmap/cora/tree/main/research/aps) | the facts report and candidate the descriptor was curated from |
