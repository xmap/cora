...
| `Diffractometer_Euler` | `Device` | Diffractometer (loose) | 4-ID-G | Huber Eulerian cradle (DIFF-1) |
| `Diffractometer_HighPressure` | `Device` | Diffractometer (loose) | 4-ID-G | high-pressure diffractometer (DIFF-1) |
