...
4-ID's diffraction core: a Huber Eulerian-cradle diffractometer and a high-pressure diffractometer. Each orients a single crystal through its circles while the detector records the scattered intensity; the reciprocal-space (h, k, l) coordination runs through hklpy2.
...
4-ID's magnetic-scattering signature: applied field and low temperature at the sample, plus a pump-probe laser.
