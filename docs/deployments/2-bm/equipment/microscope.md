...
For the pilot, persistent identifiers are stub-minted (no real DOIs registered with DataCite); the production mint path activates when 2-BM has real facility DataCite credentials.
