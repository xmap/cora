...
- Set the energy: [`set_energy`](recipes.md#set_energy) drives the optic curves to a configured energy.
...
Gas mix and compressed air are open (`SUP-1`, `SUP-2`); storage and BLEPS utilities are tracked on
