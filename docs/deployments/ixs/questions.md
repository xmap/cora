...
| DIAG-1 | Blocks-go-live | The beam-position monitors bind the graduated catalog `BeamPositionMonitor` Family; what beam-center calibration and diagnostic-foil channel detail do they need? | The graduated catalog `BeamPositionMonitor` (presents `Sensor`, distinct from `FluxMonitor` by measuring beam position rather than flux), the NSLS-II sibling choice; beam-center and foil channels to supply. | The beam-position-monitor calibration and channel detail. |
