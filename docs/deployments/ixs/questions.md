...
| CRL-1 | Nice-to-have | Whether the front-end CRL transfocator is a distinct catalog Family or folds into an existing optic plus settings (the fleet-wide question). | A loose `Transfocator`, held at gate-review across the fleet. | The transfocator's catalog home. |
