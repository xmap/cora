...
- **No new Capability or Method.** Forward CDI, ptychography, and Bragg CDI sit on the deferred coherent-imaging Methods (`TECH-1`); CDI reinforces them without coining either, and records no Practice until they land. The phase retrieval and ptychographic reconstruction are `ComputePort` work, not a Method.
