...
| `BeamPositionMonitor` | `BeamPositionMonitor` | `XF:16IDB-CT{Best}` | the Best aggregator deriving beam x / y from the TetrAMM quadrant currents (`DIAG-1`) |
