...
| `BeamPositionMonitor` | `Device` | PositionMonitor | lix-endstation | Best aggregator over the TetrAMM quadrants, `XF:16IDB-CT{Best}`; graduated catalog Family presenting `Sensor`, position-measuring (DIAG-1) |
