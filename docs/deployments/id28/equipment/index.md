...
- [Detector](detector.md): the multi-analyzer spectrometer arm bound to the loose `SpectrometerArm` (`RIXS-1`, `IXS-1`), and the Basler / PCO counting detectors plus the per-analyzer `deta1..deta9` counters bound to `Camera` (`DET-1`).
