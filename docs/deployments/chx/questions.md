...
| CRL-1 | Blocks-go-live | The focusing-optic catalog home, and the per-optic specs. CHX carries two distinct refractive focusing optics: the FOE transfocator (`XF:11IDA-OP{Lens:`) and the endstation kinoform lenses (`k1`/`k2`, `XF:11IDB-OP{Lens:1` / `{Lens:2`). The cross-deployment abstraction is open: is the catalog home a CRL-specific Family, or a more general focusing optic that also covers the kinoform? The transfocator is loose at 4-ID, 8-ID, 9-ID, and i22, held for gate-review; CHX is the fifth sighting and adds a second optic kind. | A loose `Transfocator` Family for the CRL, kept loose pending the abstraction decision (not the count); the kinoform deferred to the same decision. | The focusing-optic modelling boundary. |
