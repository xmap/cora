...
| OPTIC-3 | Nice-to-have | Should the TXM diffractive optics (Condenser, ZonePlate, PhaseRing, BetrandLens) become catalog Families? They are loose family tags today (32-ID also carries them loose). | Loose family names that render as text; no catalog graduation yet. | Catalog Family graduation (Federation-scoped). |
