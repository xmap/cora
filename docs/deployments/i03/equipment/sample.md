...
| Device | Family | Control handle | Notes |
| --- | --- | --- | --- |
| `Backlight` | `Backlight` | `BL03I` | sample illumination for on-axis viewing |
